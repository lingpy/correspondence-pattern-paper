...
r75:
	...
	#@python test_prediction.py data/chinese-203-19.tsv -r 0.75 --runs 1000
	@python test_prediction.py data/chinese-623-15.tsv -r 0.75 --runs 1000
	@python test_prediction.py data/east-polynesian.tsv -c cogid -r 0.75 --runs 1000
...
r25:
	...
	#@python test_prediction.py data/chinese-203-19.tsv -r 0.25 --runs 1000
	@python test_prediction.py data/chinese-623-15.tsv -r 0.25 --runs 1000
	@python test_prediction.py data/east-polynesian.tsv -c cogid -r 0.25 --runs 1000
...
r50:
	...
	#@python test_prediction.py data/chinese-203-19.tsv -r 0.5 --runs 1000
	@python test_prediction.py data/chinese-623-15.tsv -r 0.5 --runs 1000
	@python test_prediction.py data/east-polynesian.tsv -c cogid -r 0.5 --runs 1000
